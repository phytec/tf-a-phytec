...
void bl1_early_platform_setup(void)
{
	...
	volatile uint32_t* i2c_ptr;
	enum I2C_BUS i2c_bus = WKUP_I2C_BUS;
	...
	*uart_ptr = 0x10000;
	...
	/* Set WKUP I2C pins */
	i2c_ptr = (uint32_t*) (PADCONF_ADDR + 0x10);
	*i2c_ptr = 0x50000;
	i2c_ptr = (uint32_t*) (PADCONF_ADDR + 0x14);
	*i2c_ptr = 0x50000;
...
void bl1_platform_setup(void)
{
	...
	ret = phyflex_am62l_som_detection();
	if (ret < 0)
		ERROR("%s SOM detection failed \n", __func__);
